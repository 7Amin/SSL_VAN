...
then
  ...
  --mlp_ratios 8 8 4 4 --roi_x 96 --roi_y 96 --roi_z 96 --val_every 5 --upsample vae  --checkpoint --task $task 
...
then
  ...
  --json_list input_list/dataset_MSD_List.json --save_checkpoint --max_epochs 15000 \
  --distributed --use_normal_dataset --batch_size 1 --num_stages 4 --embed_dims 64 128 256 512 --depths 3 4 6 3 \
  --mlp_ratios 8 8 4 4 --roi_x 96 --roi_y 96 --roi_z 96 --val_every 5 --model_v VANV2 --upsample vae --checkpoint --task $task
...
then
  ...
  --json_list input_list/dataset_MSD_List.json --save_checkpoint --max_epochs 15000 \
  --distributed --use_normal_dataset --batch_size 1 --num_stages 4 --embed_dims 64 128 256 512 --depths 3 4 6 3 \
  --mlp_ratios 8 8 4 4 --roi_x 96 --roi_y 96 --roi_z 96 --val_every 5 --model_v VANV3 --upsample vae --checkpoint --task $task 
...
then
  ...
  --json_list input_list/dataset_MSD_List.json --save_checkpoint --max_epochs 15000 \
  --distributed --use_normal_dataset --batch_size 1 --num_stages 4 --embed_dims 64 128 256 512 --depths 3 4 6 3 \
  --mlp_ratios 8 8 4 4 --roi_x 96 --roi_y 96 --roi_z 96 --val_every 5 --model_v VANV4 --upsample vae --checkpoint --task $task 
...
then
  ...
  --json_list input_list/dataset_MSD_List.json --save_checkpoint --max_epochs 15000 \
  --distributed --use_normal_dataset --batch_size 1 --num_stages 4 --embed_dims 64 128 256 512 --depths 3 4 6 3 \
  --mlp_ratios 8 8 4 4 --roi_x 96 --roi_y 96 --roi_z 96 --val_every 5 --model_v VANV4GL --upsample vae --checkpoint --task $task  \
  --patch_count 2
...
then
  ...
  --mlp_ratios 6 6 4 4 --roi_x 96 --roi_y 96 --roi_z 96 --val_every 5 --model_v VANV4GLV1 --upsample vae --checkpoint --task $task  \
  --patch_count 2
...
then
  ...
  --mlp_ratios 6 6 4 --roi_x 96 --roi_y 96 --roi_z 96 --val_every 5 --model_v VANV4GLV2 --upsample vae --checkpoint --task $task  \
  --patch_count 2
...
then
  ...
  --mlp_ratios 6 6 --roi_x 96 --roi_y 96 --roi_z 96 --val_every 5 --model_v VANV4GLV2 --upsample vae --checkpoint --task $task  \
  --patch_count 3
...
then
  ...
  --json_list input_list/dataset_MSD_List.json --save_checkpoint --max_epochs 15000 \
  --distributed --use_normal_dataset --batch_size 1 --num_stages 4 --embed_dims 64 128 256 512 --depths 3 4 6 3 \
  --mlp_ratios 8 8 4 4 --roi_x 96 --roi_y 96 --roi_z 96 --val_every 5 --model_v VANV5GL --upsample vae --checkpoint --task $task  \
  --patch_count 2
