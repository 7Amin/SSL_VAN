...
from commons.models.van_v4_swin import VANV4Swin
from commons.models.van_v6_swin import VANV6Swin
...
from commons.models.van_v6gl_swin import VANV6GLSwin
...
from commons.models.pre_training.pre_van_v4_12_double import PREVANV4121double
...
def get_model(args):
    ...
    if args.model_v == "VANV4Swin":
        model = VANV4Swin(embed_dims=args.embed_dims,
                      mlp_ratios=args.mlp_ratios,
                      depths=args.depths,
                      num_stages=args.num_stages,
                      in_channels=args.in_channels,
    ...
    if args.model_v == "VANV6Swin":
        model = VANV6Swin(embed_dims=args.embed_dims,
                      mlp_ratios=args.mlp_ratios,
                      depths=args.depths,
                      num_stages=args.num_stages,
                      in_channels=args.in_channels,
    ...
    if args.model_v == "VANV6GLSwin":
        model = VANV6GLSwin(embed_dims=args.embed_dims,
                        mlp_ratios=args.mlp_ratios,
                        depths=args.depths,
                        num_stages=args.num_stages,
                        in_channels=args.in_channels,
    ...
    if args.model_v == "VANV4121Swin":
        model = VANV4121Swin(embed_dims=args.embed_dims,
                        mlp_ratios=args.mlp_ratios,
                        depths=args.depths,
                        num_stages=args.num_stages,
                        in_channels=args.in_channels,
...
def get_pre_trained_model(args):
    ...
    if args.model_v == "PREVANV4121double":
        model = PREVANV4121double(embed_dims=args.embed_dims,
                         mlp_ratios=args.mlp_ratios,
                         depths=args.depths,
                         num_stages=args.num_stages,
                         in_channels=args.in_channels,
