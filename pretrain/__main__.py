...
parser.add_argument("--phi_x", default=0.1, type=float, help="probability of masking an element along the first dimension")

parser.add_argument("--m", default=4, type=int, help="number of layers in the first dimension for all masked sequences")
...
# print(summary(model, (130, args.size_x, args.size_y)))
# model.cuda()
