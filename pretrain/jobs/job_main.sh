...
if [ $job -eq 47 ]
then
  PYTHONPATH=. python3 pretrain/main.py  --workers 8 --mode server \
   --logdir ./runs/pre_train_1/test_log --save_checkpoint --max_epochs 15000 \
  ...
  --model_inferer inferer --valid_loader valid_loader --model_v PREVANV4
fi