...
parser.add_argument("--optim_lr", default=0.0025, type=float, help="optimization learning rate")
...
parser.add_argument("--clip", default=5.0, type=int, help="Clips gradient norm of an iterable of parameters.")
