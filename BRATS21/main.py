...
parser.add_argument("--smooth_dr", default=1e-3, type=float, help="constant added to dice denominator to avoid nan")
parser.add_argument("--smooth_nr", default=1e-3, type=float, help="constant added to dice numerator to avoid zero")
