...
then
    ...
    PYTHONPATH=. python3 BRATS21/main.py --num_samples 1 --workers 8 --base_data ../images/BraTS21 \
  --json_list input_list/dataset_BRATS21_List.json --logdir ./runs/BraTS21/test_log --save_checkpoint --max_epochs 250 \
  --distributed --use_normal_dataset --batch_size 1 --roi_x 128 --roi_y 128 --roi_z 128 --val_every 1 --model_inferer inferer \
