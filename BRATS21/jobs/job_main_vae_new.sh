...
then
  ...
  --valid_loader valid_loader --model_v VANV412 --upsample vae --checkpoint --loss DiceCELoss
...
then
  ...
  --valid_loader valid_loader --model_v VANV4122GL --upsample vae --checkpoint --loss DiceCELoss
