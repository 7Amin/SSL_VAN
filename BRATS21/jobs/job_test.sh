...
if [ $job -eq 1 ]
then
  PYTHONPATH=. python3 BRATS21/main.py --squared_dice  --test_mode --workers 8 --optim_lr 0.0001 --base_data ../images/BraTS21 \
...
then
    ...
    PYTHONPATH=. python3 BRATS21/main.py --squared_dice  --test_mode --num_samples 1 --workers 8 --base_data ../images/BraTS21 \
  --json_list input_list/dataset_BRATS21_List.json --logdir ./runs/BraTS21_new/test_log --save_checkpoint --max_epochs 350 \
  --use_normal_dataset --batch_size 1 --roi_x 96 --roi_y 96 --roi_z 96 --val_every 3 --model_inferer inferer \
